...
pub fn sample_trade() -> (SidePrivate, SidePrivate, u64, u64, bool) {
    // Crossing sample: A sells at 3, B buys at 4. Each public price opens
    // its own collateral commitment.
    let a = SidePrivate {
        order_amount: 80,
        r_locked: [0xA1; 32],
    };
